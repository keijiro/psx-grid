...
#define CARD_H
#include <stdint.h>
typedef enum { CARD_OK, CARD_END, CARD_MISSING, CARD_TIMEOUT, CARD_CHANGED,
    CARD_IO, CARD_UNFORMATTED, CARD_DAMAGED } CardResult;
typedef struct { char name[21]; int size; } CardFile;
